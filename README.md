...
Public npm `latest` is `codex-agent-view@0.5.1`. This release keeps the one-invocation default-browser workflow and removes automatic `in-app-browser-context` wrapper text before deriving a task summary.
